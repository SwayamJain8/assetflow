...
async function seed() {
  ...
  const assetRows = [
    ...
    { assetTag: "AF-0062", name: "Epson Projector", categoryId: electronics!.id, status: "under_maintenance" as const, location: "HQ Floor 2", departmentId: facilities!.id, serialNumber: "EP-0062", acquisitionCost: "48000.00", acquisitionDate: "2023-08-15", condition: "poor" as const },
    ...
    { assetTag: "AF-0088", name: "Dell UltraSharp Monitor", categoryId: electronics!.id, status: "available" as const, location: "HQ Floor 2", departmentId: engineering!.id, serialNumber: "DU-0088", acquisitionCost: "45000.00", acquisitionDate: "2024-02-08", condition: "damaged" as const },
    ...
    { assetTag: "AF-0055", name: "HP LaserJet Printer", categoryId: electronics!.id, status: "available" as const, location: "HQ Floor 2", departmentId: facilities!.id, acquisitionCost: "35000.00", acquisitionDate: "2023-07-07", condition: "good" as const },
